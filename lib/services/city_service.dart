...
class CityService {
  ...
  Future<List<CityModel>> getCityModels(dynamic token) async {
    Response response;
  ...
  //get trả về response code 200
  Future<CityModel> getCityById(String id, dynamic token) async {
    Response response;
    CityModel result;
    try {
      response = await get(
  ...
  Future<CityModel> createCity(CityModel cityModel, dynamic token) async {
    Response response;
    CityModel result;
    try {
      response = await post(
  ...
  Future<bool> updateCityModel(
      String id, CityModel cityModel, dynamic token) async {
    Response response;
    bool result = false;
    try {
      response = await put(
  ...
  Future<bool> deleteCity(String id, dynamic token) async {
    Response response;
    bool result = false;
    try {
