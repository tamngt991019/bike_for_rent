...
class BookingdetailTest extends StatefulWidget {
  ...
  @override
  _BookingdetailTestState createState() => _BookingdetailTestState();
}

class _BookingdetailTestState extends State<BookingdetailTest> {
  // String bikeTypeStr = "";
  // String bikeBrandStr = "";
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                              // widget.bikeModel.licensePlates,
                              "biển",
                              style: TextStyle(fontSize: 15)),
                        ),
                      ],
